      ...
      <main className="relative z-10 pt-20">
        ...
        {!activeGame && (
          <div className="absolute top-36 left-4 glass px-3 py-2 rounded-xl pointer-events-none">
            ...
            <p className="text-[10px] text-yellow-400 mt-1">🎯 67 Headshots</p>
            <p className="text-[10px] text-purple-400 mt-1">⚡ 23 Combo</p>
            <p className="text-[10px] text-cyan-400 mt-1">💨 45 Dodge</p>
            <p className="text-[10px] text-yellow-400 mt-1">🛡️ 78 Block</p>
            <p className="text-[10px] text-purple-400 mt-1">⚔️ 34 Parry</p>
            <p className="text-[10px] text-cyan-400 mt-1">🔄 12 Reflect</p>
            ...
            <p className="text-[10px] text-yellow-400 mt-1">🌵 12% Thorns</p>
            <p className="text-[10px] text-purple-400 mt-1">🕊️ 1 Fly</p>
            ...
            <p className="text-[10px] text-cyan-400 mt-1">💰 1.8x Gold</p>
            <p className="text-[10px] text-purple-400 mt-1">📦 3x Drop</p>
            <p className="text-[10px] text-yellow-400 mt-1">🍀 2x Luck</p>
            <p className="text-[10px] text-cyan-400 mt-1">🔨 12 Forge</p>
            <p className="text-[10px] text-purple-400 mt-1">🧪 8 Brew</p>
            ...
            <p className="text-[10px] text-cyan-400 mt-1">🌾 18 Farm</p>
            <p className="text-[10px] text-purple-400 mt-1">💱 9 Trade</p>
            <p className="text-[10px] text-yellow-400 mt-1">🎭 5 Steal</p>
            <p className="text-[10px] text-cyan-400 mt-1">🩸 7 Drain</p>
            <p className="text-[10px] text-purple-400 mt-1">💋 4 Charm</p>
            <p className="text-[10px] text-yellow-400 mt-1">👻 6 Fear</p>
            <p className="text-[10px] text-purple-400 mt-1">💀 3 Curse</p>
            <p className="text-[10px] text-cyan-400 mt-1">🤐 2 Silence</p>
